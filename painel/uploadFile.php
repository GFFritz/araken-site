...
<div id="modelDocument" class="fixed hidden z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4 ">
    <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md p-5">
        <div class="flex justify-around items-center">
            ...
            <button onclick="closeModal('modelDocument')" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
        ...
        <form action="../src/helpers/uploadFile.php" method="post" enctype="multipart/form-data" class="flex flex-col gap-6">
            ...
            <input class="bg-primary hover:bg-primary-alt transition-all delay-75 text-white rounded p-4 uppercase font-bold" type="submit" value="Enviar">
        </form>
